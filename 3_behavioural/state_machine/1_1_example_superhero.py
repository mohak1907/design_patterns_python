...
# batman.clean_up() # "Can't trigger event clean_up from state asleep!"
...
# Back to the crib.
batman.complete_mission() # update kitten rescued number
print(batman.state) # 'sweaty'

batman.clean_up()
print(batman.state) # 'asleep'   # Too tired to shower!
